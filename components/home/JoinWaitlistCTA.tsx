...
const JoinWaitlistCTA = () => {
    ...
    return (
        <section ref={containerRef} id="waitlist" className="relative w-full py-12 md:py-44 bg-white font-satoshi overflow-hidden">
            ...
            <div className="max-w-[1440px] mx-auto px-6 relative flex items-center justify-between">
                ...
                <div className="w-full max-w-4xl mx-auto text-center z-10 flex flex-col items-center justify-center">
                    <h1 className="text-4xl md:text-6xl font-medium tracking-tight text-[#1A1A1A] leading-tight mb-8 max-w-5xl">
                        Be part of what comes next.
                    </h1>

                    <p className="text-lg md:text-[32px] leading-tight font-normal mb-12 max-w-5xl">
                    ...
                    <button
                        ...
                        className="group text-[15px] md:text-[17px] bg-[#1A1A1A] text-white hover:bg-[#036132] transition-all duration-300 tracking-tight px-12 py-4 rounded-full font-medium shadow-md hover:scale-105 active:scale-95 flex items-center gap-2"
