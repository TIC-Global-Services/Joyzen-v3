...
const Footer = () => {
  return (
    <footer className="relative w-full h-[50svh] sm:h-[60svh] lg:h-[65svh] bg-gradient-to-r from-[#EBF3F8] via-[#D1E0EC] to-[#A9BFCF] flex flex-col justify-between p-8 sm:p-10 lg:p-[4rem] overflow-hidden">
      {/* Top row */}
